...
<main class="d-flex flex-nowrap">
  <div class="d-flex flex-column flex-shrink-0 border rounded-3" style="width: 4.5rem; margin-left: 1rem; margin-top: 1rem; margin-bottom: 1rem;">
    <a href="/" class="d-block p-3 link-body-emphasis text-decoration-none" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Icon-only">
      <img src="../assets/nswertown_transparent.svg" width="36" height="36" alt="nswertown logo">
